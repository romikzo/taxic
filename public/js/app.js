    ...
    var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
        ...
        methods: {
            loadList: function loadList() {
                ...
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/get-persons').then(function (res) {
            ...
            loadCoordinates: function loadCoordinates() {
                ...
                __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/get-coordinates', {
                    names: this.list.filter(function (value) {
                    ...
                    if (_this2.markers.length === 0) {
                        res.data.forEach(function (element) {
                            var distance = google.maps.geometry.spherical.computeDistanceBetween(new google.maps.LatLng(element.latitude, element.longitude), new google.maps.LatLng(55.752008, 37.617501));
                            ...
                            _this2.markers[element.id] = {
                                marker: marker,
                                ballon: ballon
                            };
                        });
                    } else {
                        // или показываем нужные
                        res.data.forEach(function (element) {
                            _this2.markers[element.id].marker.setVisible(true);
                        });
                    }
                }).catch(function (err) {
                    alert('Неизвестная ошибка, подробности в консоли');
        ...
        watch: {
            toggleAllCheckbox: function toggleAllCheckbox(value) {
